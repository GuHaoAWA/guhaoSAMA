...
public abstract class swordqi_ph2 extends swordqi{
    private static final double ARROW_BASE_DAMAGE = 2.0D;
    private static final EntityDataAccessor<Byte> ID_FLAGS = SynchedEntityData.defineId(swordqi_ph2.class, EntityDataSerializers.BYTE);
    private static final EntityDataAccessor<Byte> PIERCE_LEVEL = SynchedEntityData.defineId(swordqi_ph2.class, EntityDataSerializers.BYTE);
    ...
    public swordqi_ph2.Pickup pickup = swordqi_ph2.Pickup.DISALLOWED;
    ...
    protected swordqi_ph2(EntityType<? extends swordqi_ph2> p_36721_, Level p_36722_) {
        super(p_36721_, p_36722_);
    }

    protected swordqi_ph2(EntityType<? extends swordqi_ph2> p_36711_, double p_36712_, double p_36713_, double p_36714_, Level p_36715_) {
        this(p_36711_, p_36715_);
        this.setPos(p_36712_, p_36713_, p_36714_);
    }

    protected swordqi_ph2(EntityType<? extends swordqi_ph2> p_36717_, LivingEntity p_36718_, Level p_36719_) {
        ...
        if (p_36718_ instanceof Player) {
            this.pickup = swordqi_ph2.Pickup.ALLOWED;
        }
    ...
    protected void onHitEntity(EntityHitResult p_36757_) {
        ...
        LevelAccessor level = p_36757_.getEntity().level;
        double x = p_36757_.getEntity().getX();
        double y = p_36757_.getEntity().getY();
        double z = p_36757_.getEntity().getZ();
		if (level instanceof ServerLevel _level){
            _level.sendParticles(ParticleTypes.SOUL_FIRE_FLAME, x, y, z, 1, 0, 0, 0, 0.1);
    }
    ...
    public void readAdditionalSaveData(CompoundTag p_36761_) {
        ...
        this.pickup = swordqi_ph2.Pickup.byOrdinal(p_36761_.getByte("pickup"));
    ...
    public void setOwner(@Nullable Entity p_36770_) {
        ...
        if (p_36770_ instanceof Player) {
            this.pickup = ((Player)p_36770_).getAbilities().instabuild ? swordqi_ph2.Pickup.CREATIVE_ONLY : swordqi_ph2.Pickup.ALLOWED;
        }
    ...
    public static enum Pickup {
        ...
        public static swordqi_ph2.Pickup byOrdinal(int p_36809_) {
