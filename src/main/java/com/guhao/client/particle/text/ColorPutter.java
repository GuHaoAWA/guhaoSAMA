...
public class ColorPutter {
    ...
    public static ChatFormatting[] StaticRainbow = new ChatFormatting[]{ChatFormatting.RED, ChatFormatting.GOLD, ChatFormatting.YELLOW, ChatFormatting.GREEN, ChatFormatting.AQUA, ChatFormatting.BLUE, ChatFormatting.LIGHT_PURPLE, ChatFormatting.BLACK, ChatFormatting.WHITE, ChatFormatting.DARK_RED};
    ...
    public static String rainbow3(String Input) {
        return Format(Input, StaticRainbow, 20.0D, 1) + ChatFormatting.RED + ChatFormatting.GRAY;
    }
}
